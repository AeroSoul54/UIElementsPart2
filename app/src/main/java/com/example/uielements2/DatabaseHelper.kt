...
class DatabaseHelper(var context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    override fun onCreate(db: SQLiteDatabase?) {
        ...
        //album
        val query2 = "CREATE TABLE "+TABLE_ALBUM+" ("+ ID_ALBUM+" INTEGER PRIMARY KEY, "+ ALBUM_TITLE+" TEXT, "+ ALBUM_RELEASE_DATE+" TEXT)"
        db?.execSQL(query2)

        //album song
        val query3 = "CREATE TABLE "+ TABLE_ALBUM_SONG+" ("+ ID_ALBUM_SONG+" INTEGER PRIMARY KEY, "+ ALBUM_SONG_TITLE+" TEXT, "+ ALBUM_SONG_ARTIST+" TEXT)"
        db?.execSQL(query3)
    }
